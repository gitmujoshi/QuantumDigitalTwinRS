...
class BamlSyncClient:
    ...
    def ParsePulseFromIntent(self, user_intent: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ParsePulseFromIntent", args={
...
class BamlStreamClient:
    ...
    def ParsePulseFromIntent(self, user_intent: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.QuantumPulse, types.QuantumPulse]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ParsePulseFromIntent", args={
            "user_intent": user_intent,
        })
        return baml_py.BamlSyncStream[stream_types.QuantumPulse, types.QuantumPulse](
          result,
...
class BamlHttpRequestClient:
    ...
    def ParsePulseFromIntent(self, user_intent: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ParsePulseFromIntent", args={
            "user_intent": user_intent,
        }, mode="request")
        return result
